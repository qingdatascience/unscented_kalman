...
int main(int argc, char* argv[]) {
  ...
  //cout<<"check_arguments finished"<<endl;
  ...
  //cout<<"check_files finished"<<endl;
  ...
  //cout<<"prep the measurement packages finished"<<endl;

  // Create a UKF instance
  UKF ukf;

  //cout<<"UKF initialization finished in main"<<endl;
